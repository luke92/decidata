...
def generarExcelEImagen(ms):
    ...
    writer = pd.ExcelWriter('..\Resultados\Colores de Pendiente y Enganche por tipologia.xlsx')
    ...
    a.save("..\Resultados\Colores de Pendiente y Enganche por tipologia.pdf")
